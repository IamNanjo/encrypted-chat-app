const title = "Encrypted Chat App";
const description = "End-to-end encrypted realtime chat app ";
...
export default defineNuxtConfig({
  ...
  app: {
    ...
    head: {
      ...
      meta: [
        ...
        { name: "keywords", content: categories.join(", ") },
      ],
    },
  },
  ...
  pwa: {
    ...
    manifest: {
      ...
      screenshots: [
        {
          src: "screenshots/chat-with-messages.png",
          type: "image/png",
          sizes: "1280x720",
          form_factor: "wide",
        },
        ...
        {
          src: "screenshots/user-search.png",
          type: "image/png",
          sizes: "1280x720",
          form_factor: "wide",
        },
        ...
        {
          src: "screenshots/chat-with-messages-mobile.png",
          type: "image/png",
          sizes: "1082x2400",
          form_factor: "narrow",
        },
        ...
        {
          src: "screenshots/user-search-mobile.png",
          type: "image/png",
          sizes: "1082x2400",
          form_factor: "narrow",
        },
        {
          src: "screenshots/user-profile-mobile.png",
          type: "image/png",
          sizes: "1082x2400",
          form_factor: "narrow",
        },
